...
const [footerResponse] = await Promise.all([
      ...
      <div className="flex justify-center items-center gap-4">
        ...
        {[1, 2, 3].map((product, index) => (
          <div
            key={index}
            className="border shadow-md rounded-lg p-4 w-64 min-h-[400px] flex flex-col justify-between"
          >
            {/* Product Image with Red Border */}
            <div className="h-48 flex justify-center items-center rounded-md mb-4 border border-red-500">
              <p className="text-black font-bold">Product Image</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 font-semibold">Product Rate</p>
            </div>

            {/* Buy Button */}
            <div className="flex justify-center mt-4">
              <button className="px-4 py-2 bg-green-500 text-white font-bold rounded-lg">
                Buy Now
              </button>
            </div>
          </div>
